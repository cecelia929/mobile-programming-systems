...
class YouCell: UICollectionViewCell {
    ...
    func fill(with you: [String: Any]) {
        if let avatar = you["avatar"] as? String {
            if avatar != "" {
        ...
        let username = you["first_username"] as! String

        self.avatar.accessibilityIdentifier = username

        let time = you["time"] as! String
        ...
        if let imageIDs = you["image_id"] {
            if (imageIDs as! [NSNumber]).count == 1 {
                ...
                // render image
                let image = (you["image"] as! [String])[0]
                print(image)
                ...
                var index = 0
                let images = you["image"] as! [String]
